...
export const en = {
	...
	houseCover: {
		title: "Cover image",
		description: "Add one photo to use as this house's cover (optional).",
		add: "Add cover image",
		...
		errorTooLarge: "The image must be 5 MB or smaller.",
		errorNoFile: "Please choose an image file.",
		errorGeneric: "Could not upload the image: {error}",
	},
	houseForm: {
		name: "Name",
...
export const es: Dictionary = {
	...
	houseCover: {
		...
		description: "Añade una foto para usar como portada de esta casa (opcional).",
		add: "Añadir imagen de portada",
		replace: "Reemplazar imagen",
		remove: "Eliminar imagen",
		uploading: "Subiendo…",
		alt: "Imagen de portada de {name}",
		errorInvalidType: "Elige una imagen JPEG, PNG o WebP.",
		errorTooLarge: "La imagen debe ocupar 5 MB o menos.",
		errorNoFile: "Elige un archivo de imagen.",
		errorGeneric: "No se pudo subir la imagen: {error}",
	},
	houseForm: {
		name: "Nombre",
